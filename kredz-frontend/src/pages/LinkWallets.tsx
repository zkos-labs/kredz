    ...
    <div className="min-h-screen pt-24 px-6 pb-16 flex items-center justify-center relative bg-transparent">
      <div className="w-full max-w-lg relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
          <p className="font-inter text-sm text-accent uppercase tracking-widest mb-3">Multichain Identity</p>
          ...
          <p className="font-inter text-light/50 text-sm leading-relaxed max-w-sm mx-auto">
            Connect your Midnight, Base, and Solana wallets to create a unified KREDZ identity. Your score will be provable on all three chains.
          </p>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}
          ...
          <p className="font-inter text-xs text-light/50 leading-relaxed">
            Linking stores your Base and Solana addresses on Midnight via ZK circuits. Your KREDZ Score will be bridged to all three chains automatically by the attestation relayer after each score update.
          </p>
        </motion.div>
